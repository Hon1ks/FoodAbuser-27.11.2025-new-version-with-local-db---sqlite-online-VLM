...
- [✅] Экран регистрации/входа и базового профиля
- [❌] Главный экран с дневной сводкой и навигацией
- [❌] Экран добавления приёма пищи (камера, галерея, описание, категория, время, порция)
- [❌] Дневник питания (календарь, история, фильтры, редактирование)
- [❌] Аналитика (графики, рекомендации, паттерны)
- [❌] Настройки (уведомления, приватность, экспорт, цели)

### 5. Интеграция и хранение данных
- [❌] Настроить Supabase (аутентификация, хранение данных, хранение изображений)
- [❌] Реализовать офлайн-режим и синхронизацию

### 6. Функционал анализа фото и ИИ-помощник
- [❌] Интегрировать модуль анализа фото (распознавание еды, КБЖУ)
- [❌] Реализовать ИИ-помощника для рекомендаций
